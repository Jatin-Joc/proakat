...
export class ProductCreateComponent implements OnInit {
  ...
  constructor(
    ...
    this.addProductForm = this.formBuilder.group({
      productName: ['', [Validators.required,Validators.pattern(/^[a-zA-Z0-9\s]+$/),Validators.minLength(3),Validators.maxLength(100)]],
      ...
      brand: ['', [Validators.required,Validators.pattern(/^[a-zA-Z0-9\s]+$/)]],
      coverImage: ['']
    });    
  }
